...
const Banner = () => {
  return (
    <div className=" main_Banner">
      <div className="container banner_containers">
        <div className="d-flex justify-content-around align-items-center Banner_container">
                ...
                <div className="d-flex justify-content-around align-items-center ">
                  ...
                  <div className="image_div">
                    <img
                      ...
                      height="70px"
                      className="rounded"
                      src="https://new.axilthemes.com/demo/template/etrade/assets/images/others/author1.png"
                      alt=""
                    />
                    <img
                      width="70px"
                    ...
                    <img
                      ...
                      height="70px"
                      className="rounded"
                      src="https://new.axilthemes.com/demo/template/etrade/assets/images/others/author3.png"
                      alt=""
                    />
                    <img
                      width="70px"
                      height="70px"
                      className="rounded"
                      src="https://new.axilthemes.com/demo/template/etrade/assets/images/others/author4.png"
                      alt=""
                    />
                  </div>
                  <div className="titleDiv">
                    <div className="small-ratings">
                      ...
                      <div className="reew">
                        ...
                        <span className="title_rev_container">
                          <span className="title_rev">Reviews</span>
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          <div className="banner_div right_banner">
            <div className="banner__imag">
              ...
              <div className="smoll_image">
                <img
                  className="img-fluid mini_product"
      ...
      {/* <div className="banner_sheps">
        <ul className="shep">
          <li className="shep-1">
            <img className="img-fluid" src="https://i.ibb.co/smXNfmv/shape-1.png" alt="" />
          </li>
          
          <li className="shep-2">
            <img className="img-fluid" src="https://i.ibb.co/kc7PMMz/shape-2.png" alt="" />
          </li>
